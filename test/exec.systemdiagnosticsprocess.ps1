...
.REQUIREDSCRIPTS src\sys\inc\Writer, sys\inc\Exec\Adapter\SystemDiagnosticsProcess.ps1
...
try {
    ...
    $pWriter.exception( "Exception raised when Exec\Program::setArgument() or Exec\SystemDiagnosticsProcess::setProgram:  $_" )
    Exit
}
